<template>
  <q-page padding>
    ...
    <div class="row q-col-gutter-md">
      <div class="col-md-3 col" v-for="(movie, i) in data" :key="i">
        <q-card>
          <q-img
          ...
          <q-card-section>
            ...
            <q-rating v-model="movie.rating" readonly color="orange-9" :max="5" size="32px" />
          </q-card-section>
      ...
      <q-card style="width: 500px">
        ...
        <q-card-section style="max-height: 50vh;" class="scroll">
          ...
          <q-form class="q-mt-md">
            ...
            <q-file class="q-mt-md" color="teal" filled v-model="image" label="Label">
        ...
        <q-card-actions align="right">
          ...
          <q-btn color="primary" @click="prosesTransaksi()" flat label="Proses"/>
        </q-card-actions>
      </q-card>
    </q-dialog>
  </q-page>
